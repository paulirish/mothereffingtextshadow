...
/*
    ...
    tests['draganddrop'] = function() {
        return isEventSupported('drag') && isEventSupported('dragstart') && isEventSupported('dragenter') && isEventSupported('dragover') && isEventSupported('dragleave') && isEventSupported('dragend') && isEventSupported('drop');
    };
    ...
    tests['fontface'] = function() {
        ...
        var
        sheet, head = doc.head || doc.getElementsByTagName('head')[0] || docElement,
            ...
            for (var i = 0, bool, len = props.length; i < len; i++) {
                ...
                if (bool) {
                    ...
                    if (/^range$/.test(f.type) && f.style.WebkitAppearance !== undefined) {
                        ...
                        bool = defaultView.getComputedStyle && defaultView.getComputedStyle(f, null).WebkitAppearance !== 'textfield' &&
