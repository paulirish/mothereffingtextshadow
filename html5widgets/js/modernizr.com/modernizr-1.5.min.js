...
window.Modernizr = (function(window, doc, undefined) {
    ...
    function test_props_all(prop, callback) {
        var uc_prop = prop.charAt(0).toUpperCase() + prop.substr(1),
            ...
            props = [
            prop, 'Webkit' + uc_prop, 'Moz' + uc_prop, 'O' + uc_prop, 'ms' + uc_prop, 'Khtml' + uc_prop];
...
/*
            ...
            for (var i = 0, bool, len = props.length; i < len; i++) {
                ...
                if (bool) {
                    ...
                    if (/^range$/.test(f.type) && f.style.WebkitAppearance !== undefined) {
                        ...
                        bool = doc.defaultView.getComputedStyle && doc.defaultView.getComputedStyle(f, null).WebkitAppearance !== 'textfield' &&
    ...
    if (enableHTML5 && (function() {
        ...
        (function(p, e) {
            function q(a, b) {
                if (g[a]) g[a].styleSheet.cssText += b;
                else {
                    var c = r[l],
                        d = e[j]("style");
                    d.media = a;
            ...
            function u() {
                for (var a = -1, b; ++a < f.length;) f[a][1].parentNode.replaceChild(f[a][0], f[a][1]);
                for (b in g) r[l].removeChild(g[b]);
                g = {};
                f = []
            }
            for (var r = e.documentElement, i = e.createDocumentFragment(), g = {}, m = "abbr|article|aside|audio|canvas|command|datalist|details|figure|figcaption|footer|header|hgroup|keygen|mark|meter|nav|output|progress|section|source|summary|time|video", n = m.split("|"), f = [], o = -1, l = "firstChild", j = "createElement"; ++o < n.length;) {
                e[j](n[o]);
                i[j](n[o])
            }
